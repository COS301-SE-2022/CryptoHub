    ...
    <div className="bg-white m-4 p-4 rounded-lg w-full">
      <div className="flex flex-col mb-2">
        <div className="flex flex-row justify-between">
          ...
          <div className="flex flex-row justify-between">
            <button onClick={handleCurrencyConversion("USD","ZAR",price)} className="text-sm font-semibold mb-2 translate-y-1 ml-1 text-right p-1 px-3 rounded-md bg-gray-100 hover:bg-indigo-300 transition">
              ZAR
            </button>
            ...
            <button onClick={handleCurrencyConversion("USD","EUR",price)} className="text-sm font-semibold mb-2 translate-y-1 ml-1 text-right p-1 px-3 rounded-md bg-gray-100 hover:bg-indigo-300 transition">
              EUR
            </button>
          </div>
        </div>
